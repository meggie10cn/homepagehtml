...
$conn = mysql_connect($dbhost, $dbuser, $dbpass)
  ...
  return $string;
		...
		//<?php foreach($jobs as $field =>$value) : 
			...
			$query_result= $query_result. "<li><div class=\"type\"><span style=\"background:$jobs[10]\">$jobs[11]</span></div>";
			$query_result= $query_result. "<div class=\"company\">$jobs[3]</div>";
			$query_result = $query_result. "<div class=\"description\"><a href=\"singlejobdisplay.php\"><h5 id=\"$jobs[0]\">$jobs[1]</a>&nbsp;&nbsp;$jobs[5]&nbsp;&nbsp;jobs[4]</h5>";
			$query_result = $query_result."<span id=\"list_date\">$jobs[6]</span><?php myTruncate($jobs[2],100) ?></div>";
