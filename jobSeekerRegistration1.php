...
//*** create a connection object
  ...
  or die (mysql_error());
	...
	if($password == $confpass)
	  $query = "INSERT into seeker(role, fName, lName, email, password, phone, address, city, state, created) values ('$role', '$fname','$lname','$email','$password','$phone', '$address','$city','$state','$createddate')";
	else {
