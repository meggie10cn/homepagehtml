...
function employerValidation(){
	...
	//if (!contact_name.match(contna)) { //if the email does not match send a message to the fname
   //     alert("Letters only on First Name field!");
    //    return false;
   // }
	//if (!company_name.match(compna)) { //if the email does not match send a message to the fname
   //     alert("Letters only on Last Name field!");
   //     return false;
 //   }
	if (!phone.match(pho)) {  //if the password does not match send a message to the user
